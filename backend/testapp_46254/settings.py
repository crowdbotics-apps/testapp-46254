"""
Django settings for testapp_46254 project.
...
ROOT_URLCONF = 'testapp_46254.urls'
...
WSGI_APPLICATION = 'testapp_46254.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_46254 API",
    "DESCRIPTION": "API documentation for testapp_46254 App",
    "VERSION": "v1",
}
